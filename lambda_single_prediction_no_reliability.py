...
def build_prediction_payload(features):
    """
    Generate model prediction, class probabilities, model score, and AD status.

    The maximum class probability is returned as a descriptive, uncalibrated
    model score. No high/moderate/low reliability category is assigned.
    """
    t = time.time()
